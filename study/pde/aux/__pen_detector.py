...
class PenColorDetector:
    ...
    def detect(frame, DEBUG=False):
        ...
        wc_i_r, wc_i_g, wc_i_b = associate_pens_tips(tips_contours, combined_r_contour, combined_g_contour,
                                                     combined_b_contour)

        if DEBUG:
            draw_pen_tip_associations(combined_r_contour, combined_g_contour, combined_b_contour, tips_contours, wc_i_r,
                                      wc_i_g, wc_i_b)

        pens = determine_approx_lines_of_pens(combined_r_contour, combined_g_contour, combined_b_contour, tips_contours,
                                              wc_i_r, wc_i_g, wc_i_b)
