...
class SoundRail_E(SoundEmittable, PhysicalSimulatable, SIEffect):
    regiontype = PySI.EffectType.SI_CUSTOM_NON_DRAWABLE
    regionname = "__ SoundRail E__"
    region_display_name = "SoundRail E"

    def __init__(self, shape: PySI.PointVector = PySI.PointVector(), uuid: str = "", kwargs: dict = {}) -> None:
        kwargs["sound"] = os.getcwd() + "/plugins/study/pde/res/xylophone-e.wav"
        super(SoundRail_E, self).__init__(shape, uuid, "res/xylophone-e.png", SoundRail_E.regiontype, SoundRail_E.regionname, self.configure_body_kwargs(kwargs))
    ...
    def on_play_sound_enter_recv(self):
        ...
        if len(regions) == 1:
            regions[0].register_played_sound("E")
