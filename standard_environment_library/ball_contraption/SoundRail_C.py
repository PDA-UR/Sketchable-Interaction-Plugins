...
class SoundRail_C(SoundEmittable, PhysicalSimulatable, SIEffect):
    regiontype = PySI.EffectType.SI_CUSTOM_NON_DRAWABLE
    regionname = "__ SoundRail C__"
    region_display_name = "SoundRail C"

    def __init__(self, shape: PySI.PointVector = PySI.PointVector(), uuid: str = "", kwargs: dict = {}) -> None:
        kwargs["sound"] = os.getcwd() + "/plugins/study/pde/res/xylophone-c.wav"
        super(SoundRail_C, self).__init__(shape, uuid, "res/xylophone-c.png", SoundRail_C.regiontype, SoundRail_C.regionname, self.configure_body_kwargs(kwargs))
    ...
    def on_play_sound_enter_recv(self):
        ...
        if len(regions) == 1:
            regions[0].register_played_sound("C")
