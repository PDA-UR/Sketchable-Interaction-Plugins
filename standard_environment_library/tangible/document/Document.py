...
class Document(Tangible):
    ...
    def __init__(self, shape: PySI.PointVector = PySI.PointVector(), uuid: str="", kwargs: dict = {}) -> None:
        ...
        self.border_color = PySI.Color(0, 155, 0, 255)
    ...
    def on_add_highlight_link_emit(self) -> tuple:
        return self._uuid #, self.doc_x, self.doc_y, self.width_frac, self.height_frac, self.x_axis_normalized, self.y_axis_normalized
    ...
    def __update__(self, data):
        super(Document, self).__update__(data)

        self.shape = data["contour"]

        self.doc_width = data["width"]
        self.doc_height = data["height"]

        self.width_frac = self.doc_width / self.original_doc_width
        self.height_frac = self.doc_height / self.original_doc_height
        self.doc_x = data["x"]
        self.doc_y = data["y"]
        self.x_axis_normalized = data["x_axis"]
        self.y_axis_normalized = data["y_axis"]